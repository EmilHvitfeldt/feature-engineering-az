...
If this is the issue we should think about other methods in @sec-missing than removal.
...
This method by itself doesn't deal with all the missing values and would need to be accompanied by other methods as described in @sec-missing.
