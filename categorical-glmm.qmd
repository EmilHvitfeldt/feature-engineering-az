...
image: social-cards/categorical-glmm.png
---
...
#| fig-alt: |
#|   Scatter chart showing effect of small smoothing. Green diagonal line 
#|   (slope=1): no shrinkage. Blue horizontal line: global mean. Points sized 
#|   by observation count. Most points cluster along the green line (original 
#|   means preserved). Only smallest points are slightly pulled toward the 
#|   global mean.
smoothness <- 1
...
#|   mean.
#| fig-alt: |
#|   Scatter chart showing effect of larger smoothing. Same reference lines as
#|   before. Points now fan out between the green and blue lines: large points
#|   (many observations) stay near diagonal, small points (few observations) 
#|   are pulled strongly toward global mean.
smoothness <- 5
