...
Text data as seen in the [Text section](@sec-text), is being treated as a series of tokens.
...
-   [Edge detection and corner detection](@sec-image-edge-corner)
...
-   [Grayscale Conversion](@sec-image-grayscale)
-   [Color Modifications](@sec-image-colors)
-   [Noise Reduction](@sec-image-noise)
-   [Value Normalization](@sec-image-normalization)
...
-   [Changing brightness](@sec-image-brightness)
-   [Shifting, Flipping, Rotation](@sec-image-shift-flip-rotate)
