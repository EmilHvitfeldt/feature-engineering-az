...
- Edge detection and corner detection in @sec-image-edge-corner
- texture analysis in @sec-image-texture
...
- Grayscale conversion in @sec-image-grayscale
- color modifications in @sec-image-colors
- noise reduction in @sec-image-noise
- Value normalization in @sec-image-normalization
- resizing in @sec-image-resize
...
- Changing brightness in @sec-image-brightness
- Shifting, Flipping, Rotation in @sec-image-shift-flip-rotate
- Cropping and scaling in @sec-image-crop-scale

## Embeddings

We can also take advantage of transfer learning. People have fit image deep learning models on many images before us. And some of these trained models can be reused for us. We will look at that in @sec-image-embeddings.
