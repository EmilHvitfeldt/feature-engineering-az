...
For a broader and more comprehensive look at how to work with circular features, see the [Circular section](@sec-circular).
...
Once we have the datetime variables in the right format, all we have to do is find an appropriate circular method in the [Circular section](@sec-circular) and apply it.
