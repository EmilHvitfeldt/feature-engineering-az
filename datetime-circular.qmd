...
Once we have the datetime variables in the right format, all we have to to is find an appropriate circular method in @sec-circular and apply it.

TODO: Wait for recipes step to show how this would look
...
- Extra care and work needs to be done to find the right period

## R Examples

TODO: Add recipes steps
