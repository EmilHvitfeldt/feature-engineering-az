...
#| message: false
#| fig-cap: |
#|   All houses has fewer bedrooms than rooms itself.
#| fig-alt: |
#|   Tile chart. Total number of rooms a long the x-axis, number of bedrooms
...
#| message: false
#| fig-cap: |
#|   Same distribution with longer and longer spike at mean.
#| fig-alt: |
...
The recipes package contain a number of steps. It includes the steps `step_impute_mean()`, `step_impute_median()` and `step_impute_mode()` which imputes by the mean, median and mode respectively.

TODO: find good data set with missing values
...
TODO: wait for distribution step
