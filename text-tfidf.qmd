...
The idea of TF-IDF was first proposed in 1972 [@spark1972], while it works well in practice, it wasn't based on much theory. Efforts have been made to see how we can ground IDF calculations in theory [@robertson2004], but it doesn't change the uses.
