...
**Term Frequency inverse document frequency** is the next iteration based on term frequency we explored in @sec-text-tf.
...
Conceptually, we start by creating the term frequency matrix we created in @sec-text-tf.
