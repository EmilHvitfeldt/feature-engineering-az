...
The notable exception is the combination multi-dummy extraction as seen in @sec-categorical-multi-dummy.

The one-column-at-a-time methods can be put into 3 groups; **dummy-based**, **target-based**, and **other**.

The methods that are variations of dummy encoding as explained in @sec-categorical-dummy are:

-   @sec-categorical-binary
-   @sec-categorical-hashing
-   @sec-categorical-thermometer
-   @sec-categorical-multi-dummy

The methods that are variations of target encoding as explained in @sec-categorical-target are:

-   @sec-categorical-leave-one-out
-   @sec-categorical-leaf
-   @sec-categorical-glmm
-   @sec-categorical-catboost
-   @sec-categorical-james-stein
-   @sec-categorical-m-estimator
-   @sec-categorical-quantile
-   @sec-categorical-summary

The remaining methods don't neatly slot into the above categories:

-   @sec-categorical-label
-   @sec-categorical-ordinal
-   @sec-categorical-frequency
-   @sec-categorical-weight-of-evidence
