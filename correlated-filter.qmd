...
image: social-cards/correlated-filter.png
---
...
#| fig-alt: |
#|   Correlation matrix heatmap of numeric variables from Ames housing data.
#|   Variables arranged in grid with color indicating correlation strength
#|   (blue positive, red negative). Visible clusters of correlated features
#|   appear, particularly among size-related variables like living area,
#|   garage area, and room counts. 
ames |>
