...
talk about how we technically could just do one, as sin and cos are shifted versions

What do you do if there are multiple events of interest in the period? (summer and halloween)

if we just do one then we can handle multiple signals at the same time
