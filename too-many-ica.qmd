...
image: social-cards/too-many-ica.png
---
...
#| fig-alt: |
#|   Faceted tile chart showing 4 ICA components from MNIST as 28x28 images.
#|   ICA seeks statistically independent (not just uncorrelated) components.
#|   Patterns show localized stroke features - edges, curves, and line
#|   segments that represent independent sources of variation in digit images.
library(keras)
