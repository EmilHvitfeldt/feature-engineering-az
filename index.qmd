...
This book is rendered using [quarto](https://quarto.org/) `r quarto_version`, [R](https://www.r-project.org/) `r r_version` and [Python](https://www.python.org/) `r python_version`. The website source is hosted on [Github](https://github.com/EmilHvitfeldt/feature-engineering-az).
