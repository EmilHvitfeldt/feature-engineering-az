...
The feature engineering methods we have seen so far, have been counting based or variations thereof as seen in [TF](@sec-text-tf), [TF-IDF](@sec-text-tfidf), and [Token Hashing](@sec-text-hashing).
...
Meaning that much like [TF-IDF](@sec-text-tfidf), the order doesn't matter.
