...
The feature engineering methods we have seen so far, have been counting based or variations thereof as seen in @sec-text-tf, @sec-text-tfidf, and @sec-text-hashing.
...
Meaning that much like @sec-text-tfidf, the order doesn't matter.
