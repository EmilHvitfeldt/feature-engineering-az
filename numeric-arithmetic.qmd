...
Another thing we often do is to take the [logarithm](@sec-numeric-logarithms) of the resulting ratio to give us some better intervals.
...
Methods in [Too Many section](@sec-too-many) should be tried first.
