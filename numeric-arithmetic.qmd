...
The ordering of these ratios doesn't matter to the performance but can be helpful later on when we try to interpret the model later on. Another thing we often do is to take the logarithm [@sec-numeric-logarithms] of the resulting ratio to give us some better intervals.
