...
And it makes sense, binning will naturally create a step function like we see below, and if your predictor doesn't have that shape, you are unlikely to see as good performance as with splines @sec-numeric-splines or polynomial expansion @sec-numeric-polynomial.
