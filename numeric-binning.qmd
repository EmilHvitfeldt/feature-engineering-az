...
Below is a chart of how well using evenly split binning works when using it on our toy example. We notice that using binning doesn't really work that well for this type of data. And it makes sense, binning will naturally create a step function like we see below, and if your predictor doesn't have that shape, you are unlikely to see as good performance as with splines @sec-splines or polynomial expansion @sec-polynomiall.
