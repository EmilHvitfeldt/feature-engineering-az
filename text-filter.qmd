...
This chapter is going to be quite similar to stop word removal in @sec-text-stopwords.
...
This is very similar to what some people do as a proxy for stop word removal as seen in @sec-text-stopwords.
