...
This is similar to the scaling we saw in @sec-normalization. And we see that the only difference is whether we are aiming for the statistical properly (standard deviation of 1) or a specific decision (dividing by largest quantity seen). For this there is no specific guidance as to which method you want to use and you need to look at your data and see what works best.
