...
A well-used stemmer is the Porter Stemmer [@Porter80]. Porter himself released the implementation in the [Snowball framework](https://snowballstem.org/). The stemmer itself has implementations in almost any language you would need. The [The English (Porter2) stemming algorithm](https://snowballstem.org/algorithms/english/stemmer.html) is fully described on the website, as it is a little more advanced than the S-Stemmer, and there is little advantage of copying it into these pages. The last update to the algorithm happened in October 2023, as of the time of writing.
