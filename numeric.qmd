...
Methods that take many variables and return fewer variables such as dimensionality reduction methods will be covered in @sec-too-many.
...
The power transformations we saw in @sec-numeric-boxcox and @sec-numeric-yeojohnson, distort the transformations, where these feature scalings essentially perform a "zooming" effect.
...
Centering, scaling, and normalization will all be discussed in @sec-numeric-normalization.
