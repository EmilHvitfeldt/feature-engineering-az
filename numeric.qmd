...
We see here that all the methods in @tbl-feature-scaling follow the equation @eq-feature-scaling. Sometimes $a$ and $b$ take a value of 0, which is perfectly fine. Centering and scaling when used together is equal to normalization. They are kept separate in the table since they are sometimes used independently. Centering, scaling, and normalization will all be discussed in @sec-numeric-normalization.
