...
We see here that all the methods in @tbl-feature-scaling follows the equation @eq-feature-scaling. Sometimes $a$ and $b$ takes a value of 0, which is perfectly fine.
