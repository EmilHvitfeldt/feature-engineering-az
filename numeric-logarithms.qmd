...
As shown above, a multiplicative increase can be translated into an additive increase by using a logarithmic transformation.
...
On the other hand, if we set the offset to 0.001, we get that the difference from 0 to 1 is the same as the distance from 1 to 1,000, or the same as multiplying by 1,000.
