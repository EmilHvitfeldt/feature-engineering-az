...
image: social-cards/numeric-sqrt.png
---
...
#| fig-alt: |
#|   Histogram of average daily rate from hotel bookings data. Highly
#|   right-skewed with most values clustered near zero, but a long tail
#|   extending into the thousands. Contains some negative values.
...
#| fig-alt: |
#|   Histogram after applying signed square root transformation. The
#|   distribution is much less skewed, with the bulk of values now more
#|   spread out and the extreme tail compressed. Negative values are
#|   preserved through the signed transformation.
