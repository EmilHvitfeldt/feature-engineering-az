...
: All normalization methods {#tbl-normalization}

We see here that all the methods in @tbl-normalization follows the equation @eq-normalization. Sometimes $a$ and $b$ takes a value of 0, which is perfectly fine.
