...
Each we would be able to uniquely encode `2^5=32` different value with just 5 columns compared to the 32 it would take if you used dummy encoding from @sec-categorical-dummy. In general, you will be able to encode `n` variables in `ceiling(log2(n))` columns.
