...
Simple imputation in @sec-missing-simple is when you use the values in the variable to impute its missing values, which is where mean and mode imputation are found.
Anything more complicated than this will be found in @sec-missing-model.
