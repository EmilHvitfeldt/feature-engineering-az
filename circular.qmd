---
pagetitle: "Feature Engineering A-Z | Circular Overview"
---

# Circular Overview {#sec-circular}
...
But a special type of relationship is the circular type.
...
Harmonic calculations using trigonometric functions will be showcased in @sec-circular-trig, Essentially what happens is that we are mapping the features to the unit circle in 2 dimensions.
...
Splines are covered in @sec-circular-splines, and the other more general methods are covered in @sec-circular-indicators.