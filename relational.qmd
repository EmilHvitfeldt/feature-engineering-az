...
Except for [image data](@sec-image) and to some degree [time series data](@sec-time-series).
...
[Manually](@sec-relational-manual) and [automatically](@sec-relational-auto).
