...
**Thermometer encoding** (also called **Rank Hot Encoding**) is a variation of dummy encoding as seen in @sec-categorical-dummy. It is intended only for ordinal data.
