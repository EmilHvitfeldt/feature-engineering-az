...
#| fig-alt: "6 histograms of distribution, in 2 columns. Left column shows unaltered distributions. Right column shows distribution of the Box-Cox transformation of the left column. Right column are mostly normally distributed."
set.seed(1234)
...
#| message: false
#| fig-cap: "Before and After Box-Cox"
#| fig-alt: "6 histograms of distribution, in 2 columns. Left column shows unaltered distributions. Right column shows distribution of the Box-Cox transformation of the left column. Right column have not benefitted from the Box-Cox transformation"
set.seed(1234)
...
{recipes} provides a step to perform Box-Cox transformations, which out of the box uses $e$ as the base with an offset of 0.
