...
In [Logarithms](@sec-numeric-logarithms) we saw how they could be used to change the distribution of a variable.
...
Take a look at the [Yeo-Johnson method](@sec-numeric-yeojohnson ) that tries to accomplish the same thing, and it works on positive as well as negative numbers.
