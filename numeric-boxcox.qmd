...
In @sec-numeric-logarithms on logarithms, we saw how they could be used to change the distribution of a variable.
...
Take a look at @sec-numeric-yeojohnson about the Yeo-Johnson method that tries to accomplish the same thing, and it works on positive as well as negative numbers.
