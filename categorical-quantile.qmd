...
Quantile encoding [@quantile2021], is a reimagined version of [Target Encoding](@sec-categorical-target) and [M-estimator Encoding](@sec-categorical-m-estimator) that uses quantiles instead of means and M regulatization from M-estimator.
