...
This is different than time as we talked about in the [Time Series section](@sec-time-series), as when we talk about time series data, it is typically a series of data points that are related, and we use that inherent structure of the data as the basis for the modeling problem.
...
Lastly, we will talk about how many of these features work in a very circular way in @sec-datetime-circular.
