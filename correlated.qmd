...
Another set of methods that works well in anything PCA-related, which are split into two chapters, one explaining [PCA](@sec-too-many-pca) and one going over [PCA varients](@sec-too-many-pca-variants).
