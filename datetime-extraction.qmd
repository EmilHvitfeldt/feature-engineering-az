...
If you are, then read more about how to handle that in @sec-time-series.
...
Sometimes it will be worth extracting the categorical version and using it directly or embedding it with other methods in @sec-categorical.
