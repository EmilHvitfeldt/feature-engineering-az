...
Some of the measurements here can be extracted as categorical rather than numeric, things like `day of week` can either be extracted as `1, 2, 3` or `Monday, Tuesday, Wednesday` or `month` that can be extracted . We can think of the numeric extract as being a automatic label encoding @sec-categorical-label of the categorical version. Some times it will be worth extracting the categorical version and use it directly or embed it with other methods in @sec-categorical.
