...
If you are, then read more about how to handle that in the [Time Series section](@sec-time-series).
...
We can think of the numeric extract as being an automatic [Label Encoding](@sec-categorical-label) of the categorical version.
Sometimes it will be worth extracting the categorical version and using it directly or embedding it with other methods in the [Categorical section](@sec-categorical).
