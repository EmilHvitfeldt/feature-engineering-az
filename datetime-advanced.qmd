...
We can play around with "distance from" and "distance to", different numerical transformations we saw in [Numeric Overview](@sec-numeric), and signs and indicators we talked about in @sec-datetime-extraction to tailor our feature engineering to our problem.
...
We will cover explicit circular methods in @sec-datetime-circular.
