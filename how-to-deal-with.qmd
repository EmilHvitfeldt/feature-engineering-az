...
Some methods requires information to be transformed, that we are not able to supply beforehand. In the case of centering of numeric variables described in @sec-normalization. To be able to do this transformation, you need to know the mean value of the training data set. This mean is the sufficient information needed to perform the calculations, and is the reason why the method is a *learned* method.

On the other hand, taking the square root of a variable as described in @sec-sqrt isn't a learned method as there isn't any sufficient information needed. The method can be applied right away.
