...
image: social-cards/too-many-zv.png
---
...
1. Calculate the number of unique values of each predictor
2. Identify predictors with 1 unique value
3. Tag those predictors for removal
4. Remove predictors now, and for future data sets

For computational reasons you might want to combine 1. and 2. to instead identify predictors with more than 1 value.
this typically runs a lot faster as you can determine that there is more than 1 unique values after a handful of values.
